...
## 1.157.0
### Added
- Added "Configure Pipeline" option in Command Palette( Ctrl + Shift + P ) and for right click File Explorer. This will configure a continuous deployment pipeline to Azure Web App
